...
public class BookControllerIntegrationTests {
    ...
    public void testThatListBooksIndexReturnsBooks() throws Exception {
        ...
        mockMvc.perform(
                ...
                MockMvcResultMatchers.jsonPath("$.content.[0].author").value(book.getAuthor())
        );
    }
    ...
    @Test
    public void testThatUpdateBookReturns200OkWhenBookExists() throws Exception {
        Book book = TestDataUtil.createTestBook(null);
        bookService.save(book.getIsbn(), book);
    ...
    @Test
    public void testThatUpdateBookReturnsUpdatedBookWhenExists() throws Exception {
        Book book = TestDataUtil.createTestBook(null);
        bookService.save(book.getIsbn(), book);
    ...
    @Test
    public void testThatPartalUpdateExistingBookReturnsHttpStatus200Ok() throws Exception {
        Book book = TestDataUtil.createTestBook(null);
        book = bookService.save(book.getIsbn(), book);
    ...
    @Test
    public void testThatPartalUpdateNotExistingBookReturnsHttpStatus404NotFound() throws Exception {
        BookDto bookDto = TestDataUtil.createTestBookDto(null);
        bookDto.setTitle("Updated");
        String bookDtoJson = objectMapper.writeValueAsString(bookDto);
    ...
    @Test
    public void testThatPartalUpdateExistingBookReturnsUpdatedBook() throws Exception {
        Book book = TestDataUtil.createTestBook(null);
        book = bookService.save(book.getIsbn(), book);
    ...
    @Test
    public void testThatDeleteBookReturnsHttpStatus204NoContentWhenBookExists() throws Exception {
        Book book = TestDataUtil.createTestBook(null);
        bookService.save(book.getIsbn(), book);
    ...
    @Test
    public void testThatDeleteBookReturnsHttpStatus404NotFoundWhenBookDoesNotExist() throws Exception {
        mockMvc.perform(
                MockMvcRequestBuilders.delete("/books/9-9-9")
                        .contentType(MediaType.APPLICATION_JSON)
        ).andExpect(
                MockMvcResultMatchers.status().isNotFound()
        );
